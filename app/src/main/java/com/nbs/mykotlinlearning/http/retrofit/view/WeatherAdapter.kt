...
import com.nbs.mykotlinlearning.http.retrofit.data.mapper.Weather
 ...
 */
class WeatherAdapter(val context: Context, val list: ArrayList<Weather>): RecyclerView.Adapter<WeatherAdapter.WeatherViewholder>() {
    ...
    class WeatherViewholder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        fun bindData(weather: Weather){
            with(weather){
                val tempMinMax = "${formatCelcius(temp.min)}°C / ${formatCelcius(temp.max)}°C"
